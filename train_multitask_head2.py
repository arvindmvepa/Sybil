...
class MultiTaskHead(nn.Module):
    def __init__(self, input_dim, num_classes_per_task, num_regression_tasks, hidden_dim=512):
        ...
        for num_classes in num_classes_per_task:
            self.classification_heads.append(nn.Linear(hidden_dim, num_classes))
        
        # Regression head
        self.regression_head = nn.Linear(hidden_dim, num_regression_tasks)
...
def main():
    ...
    parser.add_argument('--save_dir', default='./multitask2', help='Directory to save checkpoints')
